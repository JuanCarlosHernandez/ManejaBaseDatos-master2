...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickAgregar(View v)
    {
        ...
        //Convert image into a bytes flow
        Bitmap bitmFoto = ((BitmapDrawable)imgFoto.getDrawable()).getBitmap();
        ByteArrayOutputStream bytesImagen = new ByteArrayOutputStream(20480); //limit of size
    ...
    public void onClickTomaFoto(View v)
    {
        ...
        startActivityForResult(intcamara, 0); //Para asumir que si se dio el permiso (Timi)
    }

    @Override //Solo se escribe onActivity y se sobrecarga el método
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        super.onActivityResult(requestCode, resultCode, data);
        //Obteniendo imagen de la camara
